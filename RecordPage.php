...
<head>
    ...
    <title>Transaction History</title>
        ...
        #Table tr:hover{ background-color:#90EE90; }
        #Table th { padding-top: 12px; padding-bottom: 12px; text-align:left; background-color:#008000; color:white; }
        footer {
...
<body>
  ...
  <?php include('navbar.php'); ?>
	<div class="container">
        <h2 style="text-align: center"><u>Transaction History</u></h2>
...
<footer style="text-align: center; background-color:#00FF7F">
  <h3>Coded And Designed By: Ritu Anuragi</h3>
</footer>
<body>
